...
import static nl.vinstaal0.Dungeonrealms.ItemMechanics.ItemStacks.TeleportationScrolls.Harrison_scroll;
...
public class TeleportToHarrisonsFields implements MenuItem {
	...
	public void execute(Player plr, ClickType click) {
		ItemStack tp = ItemTracker.addSerialNumber(Harrison_scroll);
