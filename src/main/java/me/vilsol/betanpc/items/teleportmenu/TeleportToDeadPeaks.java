...
import static nl.vinstaal0.Dungeonrealms.ItemMechanics.ItemStacks.TeleportationScrolls.Deadpeaks_Mountain_Camp_scroll;
...
public class TeleportToDeadPeaks implements MenuItem {
	...
	public void execute(Player plr, ClickType click) {
		ItemStack tp = ItemTracker.addSerialNumber(Deadpeaks_Mountain_Camp_scroll);
